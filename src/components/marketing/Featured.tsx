   ...
   <Container  >
     <div id={id} className="bg-transparent text-white py-10 w-full  ">
        <div className="text-left sm:text-center  flex justify-center items-center">
           ...
           <h1 data-aos="fade-right" className="text-white text-[25px] sm:text-[30px] sm:text[40px] md:text-[60px] font-[700] " >Digital Currency for Aizu-Wakamatsu</h1>
            <h3 data-aos="fade-right" className="text-[#2865FF] text-[20px] sm:text[30px] md:text-[40px] font-[700] ">Revolutionizing Transactions with Local Digital Innovation</h3>
