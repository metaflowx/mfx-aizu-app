export const StakeABI = [
  ...
  { inputs: [], name: "InvalidTierId", type: "error" },
  ...
  },
  {
    inputs: [
      ...
      { internalType: "bool", name: "isUnstakedEnabled_", type: "bool" },
  ...
  {
    inputs: [],
    name: "aizuIcoContract",
    outputs: [{ internalType: "contract IAIZUICO", name: "", type: "address" }],
  ...
  {
    inputs: [{ internalType: "uint256", name: "tierId_", type: "uint256" }],
    name: "getTier",
    outputs: [
      {
        components: [
          ...
          { internalType: "bool", name: "isUnstakedEnabled", type: "bool" },
        ],
        internalType: "struct IAIZUStaking.Tier",
        name: "",
        type: "tuple",
      },
    ],
  ...
  {
    inputs: [
      { internalType: "address", name: "aizuToken_", type: "address" },
      { internalType: "address", name: "aizuIcoContract_", type: "address" },
    ],
    name: "initialize",
    outputs: [],
    stateMutability: "nonpayable",
    ...
    outputs: [
      {
        ...
        internalType: "struct IAIZUStaking.Staker",
        name: "",
        type: "tuple",
      },
    ],
