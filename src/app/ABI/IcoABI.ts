...
export const IcoABI = [
  ...
  { inputs: [], name: "SaleNotEnded", type: "error" },
  {
    inputs: [
      {
        internalType: "enum IAIZUICO.Status",
        name: "currentStatus",
        type: "uint8",
      },
    ],
  ...
  },
  {
    inputs: [
      {
        internalType: "enum IAIZUICO.SaleType",
        name: "saleType",
        type: "uint8",
      },
    ],
  ...
  {
    inputs: [],
    name: "aizuReferralContract",
    outputs: [
      { internalType: "contract IAIZUReferral", name: "", type: "address" },
    ],
  ...
  {
    inputs: [],
    name: "aizuStakingContract",
    outputs: [
      { internalType: "contract IAIZUStaking", name: "", type: "address" },
    ],
    stateMutability: "view",
    type: "function",
  },
  ...
  },
  {
    inputs: [
      ...
      {
        internalType: "enum IAIZUICO.SaleTokenOption",
      ...
      },
      {
        ...
        internalType: "struct IAIZUICO.Vesting",
        name: "vesting_",
        type: "tuple",
      },
    ...
    outputs: [
      {
        ...
        internalType: "struct IAIZUICO.PaymentOption",
        name: "",
        type: "tuple",
      },
    ],
  ...
  {
    inputs: [
      { internalType: "address", name: "aizuSaleToken_", type: "address" },
      {
        internalType: "address",
        name: "aizuReferralContract_",
        type: "address",
      },
      {
        internalType: "address",
        name: "aizuStakingContract_",
        type: "address",
      },
    ],
    name: "initialize",
    ...
    outputs: [
      {
        ...
        internalType: "struct IAIZUICO.ICO",
        name: "",
        type: "tuple",
      },
    ],
  ...
  },
  {
    ...
    name: "updateaizuReferralContract",
    outputs: [],
    stateMutability: "nonpayable",
    type: "function",
  },
    ...
    outputs: [
      {
        ...
        internalType: "struct IAIZUICO.Claimable",
        name: "",
        type: "tuple",
      },
    ],
    ...
    outputs: [
      {
        ...
        internalType: "struct IAIZUICO.Contributor",
        name: "",
        type: "tuple",
      },
    ],
